        ...
        {leaderboard.slice(0, 3).map((user) => (
          ...
          >
            <div className="flex justify-center mb-4">
              {user.rank === 1 && <Trophy className="h-12 w-12 text-yellow-400" />}
              {user.rank === 2 && <Medal className="h-12 w-12 text-gray-400" />}
              {user.rank === 3 && <Award className="h-12 w-12 text-orange-400" />}
            </div>
